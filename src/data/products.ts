...
/*
  Archived demo catalog:
  All products from the previous mock storefront are kept here as comments.
  The live app now loads an empty catalog to avoid demo stock surfacing.
...
// The demo catalog has been archived above as a reference block.
// Add real products back here when the live catalog is ready.
