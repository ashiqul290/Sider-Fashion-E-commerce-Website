    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-2xl border border-stone-200 shadow-xs space-y-2">
          ...
          <div className="text-2xl font-black text-stone-950 font-sans select-none">
        ...
        <div className="bg-white p-5 rounded-2xl border border-stone-200 shadow-xs space-y-2">
          ...
          <div className="flex items-baseline gap-2 text-stone-950 select-none">
            <span className="text-xl font-black">৳{analytics.retailSales.toLocaleString()}</span>
            <span className="text-xs font-semibold text-stone-500">Retail</span>
          </div>
          <div className="flex items-center justify-between text-xs text-stone-500 pt-1 border-t border-stone-100">
            <span>Orders: <strong className="text-stone-900">{filteredOrders.length}</strong></span>
        ...
        <div className="bg-white p-5 rounded-2xl border border-stone-200 shadow-xs space-y-2">
          ...
          <div className="text-2xl font-black text-emerald-700 font-sans select-none">
